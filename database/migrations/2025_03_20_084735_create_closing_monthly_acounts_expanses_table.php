...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('closing_monthly_acounts_expanses', function (Blueprint $table) {
             $table->id('openning_monthly_acounts_expanses_id');
            $table->date('opening_date');
            $table->integer('opening_monthly_id');
            $table->integer('opening_monthly_account_id');
    ...
    {
        Schema::dropIfExists('closing_monthly_acounts_expanses');
    }
};
