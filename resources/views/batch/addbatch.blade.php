            ...
            <div class="col-8">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="batch_title" type="text" name="batch_title" value="{{ old('batch_title', $batch->batch_title) }}"
                            class="form-control" id="batch_title">
                        <span class="text-danger">
                            @error('batch_title')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="batch_no" type="text" name="batch_no" value="{{ old('batch_no', $batch->batch_no) }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" name="expire_date" value="{{ old('expire_date', $batch->expire_date) }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="remark" value="{{ old('remark', $batch->remark) }}"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input id="import_info" type="text" name="import_info" value="{{ old('import_info', $batch->import_info) }}"
                            class="form-control" id="import_info">
                        <span class="text-danger">
                            @error('import_info')
                                {{ $message }}
                            @enderror
        ...
        $(document).ready(function() {
             $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, customer) {
                        $('#customers').append('<option value="' + customer.customer_id + '">' + customer
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    productList = data;
                    $.each(data, function(key, customer) {
                        $('#products').append('<option value="' + customer.product_id + '">' + customer
                            .product_name + '</option>');
                    });
                }
            });
                ...
                if (productId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#existingBatchItems').append('<option value="">Existing Batch List ('+data.length+')</option>');
                            $.each(data, function(key, item) {
                                $('#existingBatchItems').append('<option value="'+item.batch_id+'">'+item.batch_title+'</option>');
                            });
                        }
                    });
                } else {
