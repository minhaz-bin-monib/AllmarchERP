...
<head>
    <title>Exchange Delivery Invoice {{ $customer->customer_name }}</title>
    <style>
        * {
            margin: 0px;
            padding: 0px;
...
<body>
    ...
    <div class="row w-70 middle ">
        ...
        <div class="row textC" style="margin-bottom: 20px">
            <h2 style="font-size: 16px;">Exchange Delivery Receipt</h2>
            <div class="watermark">Exchange</div>
        </div>
        ...
        <div class="row middle" style="width: 97%">
            <div class="w-60 floatL" >
                ...
                <p>Factory: {{$customer->customer_address}}</p>
            </div>
        ...
        <div class="row middle" style="width: 98%">
            <table style="width: 100%">
                ...
                @endforeach
                    <tr>
                        <td class="textC" colspan="4"><b>Total</b></td>
