...
<head>
    <title>TRUCK RECEIPT Invoice</title>
    <style>
        * {
            margin: 0px;
            padding: 0px;
...
<body>
    ...
    @endphp
        ...
        <div class="row textC" style="margin-bottom: 20px">
            <h2 style="font-size: 16px;">TRUCK RECEIPT</h2>
        </div>
        ...
        <div class="row middle" style="width: 100%">
            ...
            <div class="w-50 floatL textR">
                <p>TRUCK RECEIPT NO : {{ $transferInvoice->proforma_invoice }}</p>
                ...
                <tbody>
                    ...
                    @foreach ($transferInvoiceProduct as $salesInvProd)
                        ...
                        <tr>
                            ...
                            <td class="textR"></td>
                            <td>TOTAL:</td>
                            <td class="textR">{{ number_format( $totalWeightCount,2)}} Kg</td>
                            {{-- <td class="textR"></td>
                            <td class="textR">{{ number_format($totalPrice) }}</td> --}}
