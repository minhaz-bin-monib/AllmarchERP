...
<!-- Set Title -->
@push('title')
    <title>Add Exchange Invoice</title>
@endpush
        ...
        <form action="{{ $url }}" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select data-live-search="true"data-live-search="true" id="products" name="product_id"
                        class="form-control">
                        <option value="" selected="">Select</option>
                ...
                <tbody>
                    ...
                    @foreach ($salesInvoiceProduct as $salesInvProd)
                        ...
                        <tr>
                            ...
                            <td>
                                <a class=""
                                    href="{{ url('/exchangeInvoice/productStickar') }}/{{ $salesInvProd->salesInvoice_id }}/{{ $salesInvProd->salesInvoiceProduct_id }}">Special</a>
                                <a class="btn btn-sm btn-danger"
                                    onClick="confirmDelete('{{ url('/exchangeInvoice/productDelete') }}/{{ $salesInvProd->salesInvoice_id }}/{{ $salesInvProd->salesInvoiceProduct_id }}')">
            ...
            <div class="row">
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/exchangeInvoice/exchangeCustomerInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Exchange Invoice</a>
                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/exchangeInvoice/exchangeDeliveryInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Exchange Delivery</a>
                </div>
                <div class="col-2">
                ...
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/exchangeInvoice/exchangeSpecialInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Special Invoice</a>

                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/exchangeInvoice/exchangeSpecialDeliveryInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Special Delivery</a>
                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/exchangeInvoice/exchangeSpecialCalculateInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
