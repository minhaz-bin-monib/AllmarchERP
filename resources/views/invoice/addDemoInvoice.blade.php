                        ...
                        <tr>
                            ...
                            <td>
                                <a class="" target="_blank"
                                    href="{{ url('/demoInvoice/productStickar') }}/{{ $salesInvProd->salesInvoice_id }}/{{ $salesInvProd->salesInvoiceProduct_id }}">Special</a>
                                <a class="btn btn-sm btn-danger"
                                    onClick="confirmDelete('{{ url('/demoInvoice/productDelete') }}/{{ $salesInvProd->salesInvoice_id }}/{{ $salesInvProd->salesInvoiceProduct_id }}')">
            ...
            <div class="row">
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/demoInvoice/demoCustomerInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Customer Invoice</a>
                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/demoInvoice/demoDeliveryInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                ...
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/demoInvoice/demoSpecialInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Special Invoice</a>

                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/demoInvoice/demoSpecialDeliveryPdf') }}/{{ $salesInvoice->salesInvoice_id }}"
                        target="_blank">Special Delivery</a>
                </div>
                <div class="col-2">
                    <a class="btn btn-sm btn-primary"
                        href="{{ url('/demoInvoice/demoSpecialCalculateInvoicePdf') }}/{{ $salesInvoice->salesInvoice_id }}"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            function getSalesPreviousItems(customerId, productId){
                 $.ajax({
                    url: "{{ url('/demoInvoice/demoPreviousList') }}/" + customerId + "/" +
                        productId,
                    type: "GET",
                    dataType: "json",
                    success: function(data) {
