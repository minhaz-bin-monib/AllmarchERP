...
class LoanInvoiceController extends Controller
{
   ...
   public function store(Request $request)
   {
       ...
       try {
           ...
           return redirect('loanInvoice/edit/' . $salesInvoice->salesInvoice_id)
...
*/
   ...
   public function invoiceProductDelete($invoiceId, $invoiceProductid)
   {
       try {
           ...
           // Redirect to the edit page of the newly created invoice
           return redirect('loanInvoice/edit/' . $invoiceId)
      ...
      // return redirect('/loanInvoice/list');
   }
   // [httpGet]
   ...
   // [httpGet]
   public function loanSpecialInvoicePdf($salesInvoiceId)
   {
   ...
   public function loanSpecialDeliveryInvoicePdf($salesInvoiceId)
   {
    ...
    // [httpGet]
    public function loanSpeicalCalculateInvoicePdf($salesInvoiceId)
    {
